...
export default function DocumentViewer() {
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      const next = Math.max(320, Math.floor(rect.width - 24));
  ...
  return (
    <SiteFrame>
      ...
      <div className="mt-4 grid gap-3 rounded-2xl border border-zinc-800/70 bg-zinc-950/30 p-4">
        <div className="grid gap-2" ref={dropdownRef}>
          <div className="text-sm font-semibold text-zinc-100">Select A Document</div>
          <button
            type="button"
        ...
        {hasPdf ? (
          <div ref={fullscreenRef} className="pdf-fullscreen">
            ...
            <div className="pdf-surface mt-2 overflow-hidden rounded-none border border-zinc-800/70 bg-black">
              <div className="pdf-scroll scrollbar-green h-[70vh] overflow-auto p-3" ref={pageContainerRef}>
                <Document
                  file={pdfUrl}
                  ...
                  <div className="grid gap-4">
                    {pageNumbers.map((n) => (
                      <div
                        ...
                        className="overflow-hidden rounded-none border border-zinc-800/70 bg-zinc-950/30"
                      >
          ...
          <div className="overflow-hidden rounded-none border border-zinc-800/70 bg-black">
            <div className="scrollbar-green h-[70vh] overflow-auto p-3">
